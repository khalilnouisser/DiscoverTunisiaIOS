//
//  ThreeColumnUICollectionViewLayout.swift
//  Discover Tunisia
//
...
class ThreeColumnUICollectionViewLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        self.itemSize = CGSize(width: self.cellWidth - self.minimumInteritemSpacing, height: 50)
